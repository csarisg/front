...
// 8.	Ejemplo de Ejecución: Si el usuario ingresa 10, el programa debe imprimir: “La cantidad de números impares desde 
// 0 hasta 10 (inclusive) es: 5”

const prompt = require("prompt-sync")(); 

const x = parseInt(prompt("Ingrese un número X:"));
...
console.log(`La cantidad de números impares desde 0 hasta ${x} son: ${contadorImpares}`);
