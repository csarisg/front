...
function mostrarMensaje() {
    ...
    console.log(saludoGlobal);  // Imprime el mensaje global
    console.log(saludoLocal);   // Imprime el mensaje local
}
mostrarMensaje();  // Llama a la función para mostrar los mensajes
